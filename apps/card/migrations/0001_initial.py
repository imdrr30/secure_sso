    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provided_organization', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='provider_organization', to='organization.organization')),
            ],
            options={
                'ordering': ['-created'],
                'abstract': False,
